...
public class JdbcDemo {
    public static void main(String[] args) {
        ...
        try{
            ...
            //int insert = statement.executeUpdate("INSERT INTO user VALUES (2, 'kit', 'Stark', 'ay@gmail.com', '00000')");
           ...
           // Execute queries
            ...
            //2B do this third sql command to get a read a single entry
...
//            }
            ...
            //int update = statement.executeUpdate("UPDATE user SET firstName='joy', lastName='omo' WHERE id = 1");
